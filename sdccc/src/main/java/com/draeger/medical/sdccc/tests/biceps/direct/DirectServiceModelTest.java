...
public class DirectServiceModelTest extends InjectorTestBase {
    ...
    void testRequirement0062() {
        checkServicePresenceAndConformance(
            ...
            MessageGeneratingUtil.getGetService(testClient)
        );
    }
    ...
    void testRequirement0064() {
        checkServicePresenceAndConformance(
            ...
            MessageGeneratingUtil.getStateEventService(testClient)
        );
    }
    ...
    void testRequirement0066() {
        checkServicePresenceAndConformance(
            ...
            MessageGeneratingUtil.getWaveformService(testClient)
        );
    }
    ...
    void testRequirement0068() {
        checkServicePresenceAndConformance(
            ...
            MessageGeneratingUtil.getSetService(testClient)
        );
    }
    ...
    void testRequirement0069() {
        checkServicePresenceAndConformance(
            ...
            MessageGeneratingUtil.getContextService(testClient)
        );
    }
    ...
    void testRequirement0100() {
        checkServicePresenceAndConformance(
            ...
            MessageGeneratingUtil.getArchiveService(testClient)
        );
    }
    ...
    void testRequirement0101() {
        checkServicePresenceAndConformance(
            ...
            MessageGeneratingUtil.getLocalizationService(testClient)
        );
    }
    ...
    private void checkServicePresenceAndConformance(
        ...
        final Optional<HostedServiceProxy> hostedService) {
        final var hostedServices = testClient.getHostingServiceProxy().getHostedServices();
        assertTrue(
            hostedServices.values().stream()
                .anyMatch(value ->
                    value.getType().getTypes().stream()
