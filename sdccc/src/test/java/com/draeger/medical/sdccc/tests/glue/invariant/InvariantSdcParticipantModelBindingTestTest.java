...
public class InvariantSdcParticipantModelBindingTestTest {
    ...
    public void testRequirementR0080Good() throws Exception {
        ...
        final var first = buildDescriptionModificationReport(
            ...
            buildStringOperation(SET_STRING_OPERATION_HANDLE, STRING_METRIC_HANDLE, OperatingMode.EN,
                mdibBuilder.buildCodedValue("2")),
            buildStringMetric(STRING_METRIC_HANDLE, MetricCategory.MSRMT, MetricAvailability.CONT,
                mdibBuilder.buildCodedValue("stringMetricValue"), mdibBuilder.buildCodedValue("3")),
    ...
    private Pair<ChannelDescriptor, ChannelState> buildChannel(final String handle,
    ...
    private Pair<StringMetricDescriptor, StringMetricState> buildStringMetric(final String handle,
