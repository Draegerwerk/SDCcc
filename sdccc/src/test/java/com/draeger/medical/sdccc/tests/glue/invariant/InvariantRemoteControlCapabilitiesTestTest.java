...
public class InvariantRemoteControlCapabilitiesTestTest {
    ...
    public void testRequirementR00780Good() throws Exception {
        ...
        final var part = buildOperationInvokedReportReportPart("handle",
    ...
    public void testRequirementR00780BadReportPart() throws Exception {
        ...
        final var secondPart = buildOperationInvokedReportReportPart("secondHandle",
            messageBuilder.buildInvocationInfo(1L, InvocationState.START),
            secondInstanceIdentifier);
        final var report = buildOperationInvokedReport(MdibBuilder.DEFAULT_SEQUENCE_ID, BigInteger.ONE,
            part, secondPart);
        messageStorageUtil.addInboundSecureHttpMessage(storage, report);
        assertThrows(AssertionError.class, testClass::testRequirementR00780);
    }

    OperationInvokedReport.ReportPart buildOperationInvokedReportReportPart(final String handleRef,
    ...
    Envelope buildOperationInvokedReport(final String sequenceId,
